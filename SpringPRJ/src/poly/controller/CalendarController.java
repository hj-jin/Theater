...
public class CalendarController {
	...
	@RequestMapping(value="cal/calSelect", method=RequestMethod.GET)
	public String calSelect (HttpServletRequest request, Model model) throws Exception{
		log.info(this.getClass() + ".calSelect start ");
		String stdate = CmmUtil.nvl(request.getParameter("stdate"));
		log.info("stdate : " + stdate);
		
		
		
		String url = "http://www.kopis.or.kr/openApi/restful/pblprfr?service=b0c72a78fe0b42c2a4ed40f73a1ae3ac&stdate=20181101&eddate="+stdate+"&cpage=1&rows=100&prfstate=02";
		...
		log.info(this.getClass() + ".calSelect end ");
		return "/cal/calList";
	}
	
	@RequestMapping(value="cal/calDetail")
	public String calDetail (HttpServletRequest request , Model model) throws Exception{
		log.info(this.getClass() + ".calDetail start ");
...
String url ="http://www.kopis.or.kr/openApi/restful/pblprfr/"+id+"?service=b0c72a78fe0b42c2a4ed40f73a1ae3ac";
		...
		log.info(this.getClass() + ".calDetail end ");
