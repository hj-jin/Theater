...
public class CrawlingUtil {
	...
	public static String getTheaterHTML() throws Exception {
		//크롤링 사용하기 위해서 jsoup 라이브러리를 추가해줘야합니다.
		
		//1.url 선언
		
		//String URL = "http://www.cheftruck.kr/bbs/board.php?bo_table=carnival"; 트럭
