 ...
 * Generated at: 2018-12-12 04:40:43 UTC
...
if(session.getAttribute("userSeq") != null){ 
 ...
 for(int i=0; i< uList.size(); i++){ 
      ...
      out.write("\t\t\t\t\t<tr> \r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(uList.get(i).getUserSeq());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td><a href=\"/user/userDetail.do?userSeq=");
      out.print(uList.get(i).getUserSeq());
      out.write('"');
      out.write('>');
      ...
      out.write("</a></td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(uList.get(i).getHp());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(uList.get(i).getName());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(uList.get(i).getRegDate());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(uList.get(i).getBirth());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(uList.get(i).getBirthSec());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t</tr>\t \t\t\r\n");
      out.write("\t\t\t\t\t ");
} 
